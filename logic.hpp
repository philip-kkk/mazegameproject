...
void white_goblin_move(vector<string> &maze, const vector<vector<int>> &wall, int &goblin_r, int &goblin_c,
...
void white_slime_move(vector<string> &maze, const vector<vector<int>> &wall, int &slime_r, int &slime_c,
                      bool &caught, int &player_r, int &player_c,
